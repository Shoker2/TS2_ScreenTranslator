...
class Ui_Settings(object):
	...
	def setupUi(self, Settings, icon_path=''):
		...
		self.verticalLayout.addWidget(self.originalOutput)
		self.startNewLine = QtWidgets.QCheckBox(self.scrollAreaWidgetContents)
		font = QtGui.QFont()
		font.setPointSize(10)
		self.startNewLine.setFont(font)
		self.startNewLine.setChecked(False)
		self.startNewLine.setObjectName("startNewLine")
		self.verticalLayout.addWidget(self.startNewLine)
	...
	def retranslateUi(self, Settings):
		...
		self.startNewLine.setText("Start on a new line")
	...
	def get_all(self):
		...
		get['start_on_new_line'] = str(int(self.startNewLine.isChecked()))
